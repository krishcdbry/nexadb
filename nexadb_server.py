...
class NexaDBServer:
    ...
    def start(self):
        ...
        print("║     ╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═════╝               ║")
        print("║                                                                       ║")
        print(f"║            {WHITE}Production-Grade AI Database{CYAN}                            ║")
        print("║                                                                       ║")
        print("╚═══════════════════════════════════════════════════════════════════════╝")
        print(f"{RESET}")
        ...
        print(f"\n{BLUE}{BOLD}📡 API ENDPOINTS{RESET}")
        print(f"   {WHITE}├─{RESET} {GREEN}POST  {RESET} /auth/login                   {WHITE}→{RESET} Login")
        print(f"   {WHITE}├─{RESET} {GREEN}GET   {RESET} /collections                  {WHITE}→{RESET} List collections")
        print(f"   {WHITE}├─{RESET} {GREEN}POST  {RESET} /collections/{{name}}          {WHITE}→{RESET} Insert document")
        print(f"   {WHITE}├─{RESET} {GREEN}POST  {RESET} /collections/{{name}}/bulk     {WHITE}→{RESET} Bulk insert")
        print(f"   {WHITE}├─{RESET} {GREEN}POST  {RESET} /collections/{{name}}/query    {WHITE}→{RESET} Query documents")
        print(f"   {WHITE}├─{RESET} {YELLOW}PUT   {RESET} /collections/{{name}}/{{id}}    {WHITE}→{RESET} Update document")
        print(f"   {WHITE}└─{RESET} {MAGENTA}DELETE{RESET} /collections/{{name}}/{{id}}    {WHITE}→{RESET} Delete document")
