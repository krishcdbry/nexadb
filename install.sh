...
echo -e "\n${BOLD}[3/5] Downloading NexaDB v2.2.0...${RESET}"
cd "$INSTALL_DIR"
...
mkdir -p admin_panel
curl -fsSL "https://raw.githubusercontent.com/krishcdbry/nexadb/main/admin_panel/nexadb_admin_modern.html" -o admin_panel/nexadb_admin_modern.html 2>/dev/null || true
